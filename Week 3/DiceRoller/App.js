      ...
      <SafeAreaView style={styles.container}>
        ...
        <Modal visible={modalIsVisible}>
          <SafeAreaView style={styles.modalRoot}>
            ...
            // Tie the entered value to the userGuess so when it's reset to blank the input field will also reset
            value={userGuess}
            />

            <Text style={styles.inputLabel}>Enter your wager:</Text>
            <TextInput 
            style={styles.textInput}
            // Placeholder for when it's empty
