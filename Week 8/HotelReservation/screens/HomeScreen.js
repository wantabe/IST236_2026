        ...
        <ScrollView style={styles.scrollContainer}>
          ...
          <View style={styles.rowContainer}>
            ...
            >
                <View style={styles.centeredModalView}>
                    <View style={styles.modalView}>
                        <Text style={[styles.dateText, dateTextFlex]}>Enter Number of Beds:</Text>
                        <WheelPicker 
...
// get screen dimensions down here to access them within stylesheet.
// if you do it down here, it's not dynamic so it must be for only portrait/landscape.

//const windowWidth = Dimensions.get("screen").width;

// can do stuff like this if you do:
// fontSize: windowWidth > 300 ? 40 : 20,
